  ...
  return (
    <div className="contact">
      ...
      <div className='con-left'>
        ...
        <ul>
          <li><FaSearchLocation color='#0272ce' size="1.2rem"/><a>A. Pablo St. Malinta, District I Valenzuela City</a></li>
          <li><FaPhoneAlt color='#0272ce' size="1.2rem"/><a>700-22919 | 352-1000 1815</a></li>
          <li><FaEnvelope color='#0272ce' size="1.2rem"/><a href = "mailto: vcgec@yahoo.com" target="_blank">vcgec@yahoo.com</a></li>
          <li><FaFacebookSquare color='#0272ce' size="1.2rem"/><a href='https://www.facebook.com/vcge.coop' target="_blank">facebook.com/vcge.coop</a></li>
        </ul>
